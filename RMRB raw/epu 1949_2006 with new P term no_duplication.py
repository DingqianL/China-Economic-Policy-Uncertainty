# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 10:03:41 2021
...
# for era1
epu1 = articlelist_clean2.loc[(articlelist_clean2.year>=1949)&(articlelist_clean2.year<=1978)]
epu1 = epu1.reset_index(drop = True)
epu1.head(15)
epu1.tail(15)

epu1 = epu1.iloc[9:]

std1_e = epu1.epu1_count.std()
std2_e = epu1.epu2_count.std()
std3_e = epu1.epu3_count.std()

std1_t = epu1.tpu_count.std()

epu1['epu1_index'] = epu1.epu1_count/std1_e
epu1['epu2_index'] = epu1.epu2_count/std2_e
epu1['epu3_index'] = epu1.epu3_count/std3_e

epu1['tpu_index'] = epu1.tpu_count/std1_t

epu1['epu1_index'] = epu1['epu1_index']/epu1['epu1_index'].mean()*100
epu1['epu2_index'] = epu1['epu2_index']/epu1['epu2_index'].mean()*100
epu1['epu3_index'] = epu1['epu3_index']/epu1['epu3_index'].mean()*100

epu1['tpu_index'] = epu1['tpu_index']/epu1['tpu_index'].mean()*100

epu1.to_excel(r'epu tpu 1949_1978 new P term no_duplication_09082022.xlsx')

# for era2

epu2 = articlelist_clean2.loc[(articlelist_clean2.year>=1979)&(articlelist_clean2.year<=1999)]
epu2 = epu2.reset_index(drop = True)

std1_e = epu2.epu1_count.std()
std2_e = epu2.epu2_count.std()
std3_e = epu2.epu3_count.std()

std2_t = epu2.tpu_count.std()

epu2['epu1_index'] = epu2.epu1_count/std1_e
epu2['epu2_index'] = epu2.epu2_count/std2_e
epu2['epu3_index'] = epu2.epu3_count/std3_e

epu2['tpu_index'] = epu2.tpu_count/std2_t

epu2['epu1_index'] = epu2['epu1_index']/epu2['epu1_index'].mean()*100
epu2['epu2_index'] = epu2['epu2_index']/epu2['epu2_index'].mean()*100
epu2['epu3_index'] = epu2['epu3_index']/epu2['epu3_index'].mean()*100

epu2['tpu_index'] = epu2['tpu_index']/epu2['tpu_index'].mean()*100

epu2.head(15)
epu2.tail(15)
epu2.to_excel(r'epu tpu 1979_1999 new P term no_duplication_09082022.xlsx')


# for era3
epu3 = articlelist_clean2.loc[articlelist_clean2.year>=1999]
...
epu3.head(15)
epu3.tail(15)
epu3.to_excel(r'epu tpu 2000_2006 new P term no_duplication_09082022.xlsx')
